      ...
      <Route path="/" component={Home} exact />
       ...
       <Route path="/search/:keyword" component={Display} />
        ...
        <Route path="/product/:id" component={ProductDetails} exact />
          ...
          <Route path="/password/reset/newpassword" component={NewPassword} exact />
          ...
          <ProtectedRoute path="/order/detail" component={OrderDetails} exact />
       ...
       <ProtectedRoute path="/admin/complains" isAdmin={true} component={ComplainList} exact />
       <ProtectedRoute path="/admin/coupons" isAdmin={true} component={CouponList} exact />
        <ProtectedRoute path="/admin/order/process" isAdmin={true} component={ProcessOrder} exact />
        <ProtectedRoute path="/admin/users" isAdmin={true} component={UsersList} exact />
        <ProtectedRoute path="/admin/user/:id" isAdmin={true} component={UpdateUser} exact />
        <ProtectedRoute path="/admin/reviews" isAdmin={true} component={ProductReviews} exact />
        <ProtectedRoute path="/admin/newlabor" isAdmin={true} component={NewLabor} exact />
        <ProtectedRoute path="/admin/labors" isAdmin={true} component={LaborsList} exact />
        <ProtectedRoute path="/admin/newvehicle" isAdmin={true} component={NewVehicle} exact />
        <ProtectedRoute path="/admin/vehicles" isAdmin={true} component={VehicleList} exact />
        <ProtectedRoute path="/admin/newpackage" isAdmin={true} component={NewPackage} exact />
        <ProtectedRoute path="/admin/newcoupon" isAdmin={true} component={NewCoupon} exact />
        <ProtectedRoute path="/admin/packs" isAdmin={true} component={PackagesList} exact />
        <ProtectedRoute path="/admin/uploadvideo" isAdmin={true} component={UploadVideo} exact />
       <ProtectedRoute path="/admin/vedeos" isAdmin={true} component={VediosList} exact />
       <ProtectedRoute path="/admin/uploadvideo" isAdmin={true} component={UploadVideo} exact />
       <ProtectedRoute path="/admin/updatevideo" isAdmin={true} component={UpdateVideo} exact />
